    ...
    return (
        <div className="mt-16 mx-6 lg:mx-20">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 mt-10 mb-6 p-6 items-center">
                <div className="space-y-8 mx-6 lg:mx-20">
                    <div className='block md:flex'>
                        <div className="flex justify-center md:block mb-2">
                            <svg xmlns="http://www.w3.org/2000/svg" className="h-10 w-10 md:h-8 md:w-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 8h2a2 2 0 012 2v6a2 2 0 01-2 2h-2v4l-4-4H9a1.994 1.994 0 01-1.414-.586m0 0L11 14h4a2 2 0 002-2V6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2v4l.586-.586z" />
                            </svg>
                        </div>
                        <div className="ml-0 md:ml-2 md:text-base lg:text-2xl xl:text-3xl 2xl:text-4xl font-nunito w-full">
                            ...
                            <div className="text-xs mt-2 md:block relative md:text-left text-center">
                                <span className="sm:block">BeautyGems is a global online marketplace, where</span>
                                <span className="sm:block">people come together to make sell, buy and</span>
                                <span className="sm:block">collect unique items.</span>
                            </div>
                        </div>
                    </div>
                    <div className='block md:flex'>
                        ...
                        <div className="ml-0 md:ml-2 md:text-base lg:text-2xl xl:text-3xl 2xl:text-4xl font-nunito w-full">
                            ...
                            <div className="text-xs mt-2 md:block relative md:text-left text-center">
                                <span className="sm:block">Your privacy is the highest priority of our</span>
                                <span className="sm:block">dedicated team. And if you ever need assistance</span>
                                <span className="sm:block">we are always ready to step in for support.</span>
                            </div>
                        </div>
                    </div>
                    <div className='block md:flex'>
                        ...
                        <div className="ml-0 md:ml-2 md:text-base lg:text-2xl xl:text-3xl 2xl:text-4xl font-nunito w-full">
                            ...
                            <div className="text-xs mt-2 md:block relative md:text-left text-center">
                                <span className="sm:block">Ther is no beautygems warehouse - just millions of</span>
                                <span className="sm:block">people selling the things they love. We make the</span>
                                <span className="sm:block">whole proces easy, helping you connect directly</span>
                                <span className="sm:block">with makers to find something extraordinary.</span>
                            </div>
                        </div>
                    </div>
                </div>
